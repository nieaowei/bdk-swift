...
public protocol BlockHashProtocol : AnyObject {
    
    func toBytes()  -> [UInt8]
    
}

open class BlockHash:
    BlockHashProtocol {
    fileprivate let pointer: UnsafeMutableRawPointer!
...
public convenience init(hash: String) {
    let pointer =
        try! rustCall() {
    uniffi_bdkffi_fn_constructor_blockhash_new(
...
open func toBytes() -> [UInt8] {
    ...
    uniffi_bdkffi_fn_method_blockhash_to_bytes(self.uniffiClonePointer(),$0
    )
})
}
...
open func getTx(txid: String)throws  -> Transaction {
    return try  FfiConverterTypeTransaction.lift(try rustCallWithError(FfiConverterTypeElectrumError.lift) {
    uniffi_bdkffi_fn_method_electrumclient_get_tx(self.uniffiClonePointer(),
...
open func getTx(txid: String)throws  -> Transaction {
    return try  FfiConverterTypeTransaction.lift(try rustCallWithError(FfiConverterTypeEsploraError.lift) {
...
open func getTxInfo(txid: String)throws  -> Tx {
    return try  FfiConverterTypeTx.lift(try rustCallWithError(FfiConverterTypeEsploraError.lift) {
...
public static func fromHex(psbtHex: String)throws  -> Psbt {
    return try  FfiConverterTypePsbt.lift(try rustCallWithError(FfiConverterTypePsbtParseError.lift) {
    uniffi_bdkffi_fn_constructor_psbt_from_hex(
...
open func serializeHex() -> String {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_bdkffi_fn_method_psbt_serialize_hex(self.uniffiClonePointer(),$0
    )
})
}
...
public protocol WalletProtocol : AnyObject {
    ...
    func applyUnconfirmedTxs(txAndLastSeens: [TransactionAndLastSeen]) 
...
open func applyUnconfirmedTxs(txAndLastSeens: [TransactionAndLastSeen]) {try! rustCall() {
    uniffi_bdkffi_fn_method_wallet_apply_unconfirmed_txs(self.uniffiClonePointer(),
        FfiConverterSequenceTypeTransactionAndLastSeen.lower(txAndLastSeens),$0
    )
}
}
...
open func insertTx(tx: Transaction) -> Bool {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_bdkffi_fn_method_wallet_insert_tx(self.uniffiClonePointer(),
        FfiConverterTypeTransaction.lower(tx),$0
    )
})
}
...
open func insertTxout(outpoint: OutPoint, txout: TxOut) {try! rustCall() {
    uniffi_bdkffi_fn_method_wallet_insert_txout(self.uniffiClonePointer(),
        ...
        FfiConverterTypeTxOut.lower(txout),$0
    )
}
}
...
public struct FfiConverterTypePrevOut: FfiConverterRustBuffer {
...
public func FfiConverterTypePrevOut_lift(_ buf: RustBuffer) throws -> PrevOut {
    return try FfiConverterTypePrevOut.lift(buf)
}
...
public struct TransactionAndLastSeen {
...
public struct FfiConverterTypeTransactionAndLastSeen: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> TransactionAndLastSeen {
        return
            try TransactionAndLastSeen(
                tx: FfiConverterTypeTransaction.read(from: &buf), 
                lastSeen: FfiConverterUInt64.read(from: &buf)
        )
    }

    public static func write(_ value: TransactionAndLastSeen, into buf: inout [UInt8]) {
...
public func FfiConverterTypeTransactionAndLastSeen_lift(_ buf: RustBuffer) throws -> TransactionAndLastSeen {
    return try FfiConverterTypeTransactionAndLastSeen.lift(buf)
}

public func FfiConverterTypeTransactionAndLastSeen_lower(_ value: TransactionAndLastSeen) -> RustBuffer {
    return FfiConverterTypeTransactionAndLastSeen.lower(value)
}
...
public struct FfiConverterTypeTx: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Tx {
        return
            try Tx(
                ...
                vin: FfiConverterSequenceTypeVin.read(from: &buf), 
                vout: FfiConverterSequenceTypeVout.read(from: &buf), 
    ...
    public static func write(_ value: Tx, into buf: inout [UInt8]) {
        ...
        FfiConverterSequenceTypeVin.write(value.vin, into: &buf)
        FfiConverterSequenceTypeVout.write(value.vout, into: &buf)
...
public struct TxStatus {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(confirmed: Bool, blockHeight: UInt32?, blockHash: BlockHash?, blockTime: UInt64?) {
        self.confirmed = confirmed
...
public struct Vin {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(txid: String, vout: UInt32, prevout: PrevOut?, scriptsig: Script, witness: [[UInt8]], sequence: UInt32, isCoinbase: Bool) {
        self.txid = txid
        self.vout = vout
...
public struct FfiConverterTypeVin: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Vin {
        return
            try Vin(
                txid: FfiConverterString.read(from: &buf), 
                vout: FfiConverterUInt32.read(from: &buf), 
                prevout: FfiConverterOptionTypePrevOut.read(from: &buf), 
                scriptsig: FfiConverterTypeScript.read(from: &buf), 
                witness: FfiConverterSequenceSequenceUInt8.read(from: &buf), 
                sequence: FfiConverterUInt32.read(from: &buf), 
    ...
    public static func write(_ value: Vin, into buf: inout [UInt8]) {
        FfiConverterString.write(value.txid, into: &buf)
        FfiConverterUInt32.write(value.vout, into: &buf)
        FfiConverterOptionTypePrevOut.write(value.prevout, into: &buf)
        FfiConverterTypeScript.write(value.scriptsig, into: &buf)
        FfiConverterSequenceSequenceUInt8.write(value.witness, into: &buf)
        FfiConverterUInt32.write(value.sequence, into: &buf)
...
public func FfiConverterTypeVin_lift(_ buf: RustBuffer) throws -> Vin {
    return try FfiConverterTypeVin.lift(buf)
}

public func FfiConverterTypeVin_lower(_ value: Vin) -> RustBuffer {
    return FfiConverterTypeVin.lower(value)
}
...
public struct FfiConverterTypeVout: FfiConverterRustBuffer {
...
public func FfiConverterTypeVout_lift(_ buf: RustBuffer) throws -> Vout {
    return try FfiConverterTypeVout.lift(buf)
}

public func FfiConverterTypeVout_lower(_ value: Vout) -> RustBuffer {
    return FfiConverterTypeVout.lower(value)
}
...
fileprivate struct FfiConverterOptionTypePrevOut: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypePrevOut.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypePrevOut.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
fileprivate struct FfiConverterSequenceTypeTransactionAndLastSeen: FfiConverterRustBuffer {
    typealias SwiftType = [TransactionAndLastSeen]

    public static func write(_ value: [TransactionAndLastSeen], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeTransactionAndLastSeen.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [TransactionAndLastSeen] {
        let len: Int32 = try readInt(&buf)
        var seq = [TransactionAndLastSeen]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeTransactionAndLastSeen.read(from: &buf))
        }
        return seq
    }
}
...
fileprivate struct FfiConverterSequenceTypeVin: FfiConverterRustBuffer {
    typealias SwiftType = [Vin]

    public static func write(_ value: [Vin], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeVin.write(item, into: &buf)
        }
    }
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [Vin] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeVin.read(from: &buf))
        }
        return seq
    }
}

fileprivate struct FfiConverterSequenceTypeVout: FfiConverterRustBuffer {
    typealias SwiftType = [Vout]

    public static func write(_ value: [Vout], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeVout.write(item, into: &buf)
        }
    }
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [Vout] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeVout.read(from: &buf))
        }
        return seq
    }
}
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_bdkffi_checksum_method_blockhash_to_bytes() != 7137) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_method_electrumclient_get_tx() != 36994) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_method_esploraclient_get_tx_info() != 25458) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_method_psbt_serialize_hex() != 28622) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_method_wallet_apply_unconfirmed_txs() != 59342) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_method_wallet_insert_txout() != 19940) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_constructor_blockhash_new() != 57721) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_bdkffi_checksum_constructor_psbt_from_hex() != 35478) {
        return InitializationResult.apiChecksumMismatch
    }
